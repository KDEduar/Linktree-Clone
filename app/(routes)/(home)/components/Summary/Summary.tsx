...
export function Summary(props: SummaryProps) {
    ...
    return (
        <div>
            <h2 className="text-center font-semibold text-2xl">Your EduTree is ready</h2>
            <p className="text-center">Its time to share to the wordl.</p>

            <div className="relative">
                <div className="flex justify-center mt-4">
                    <Image src={avatarUrl} alt="Avatar"
                    width={120} height={120}
                    className="rounded-full border-4 border-white aspect-square object-cover shadow-xl" />
                </div>
                <div className="">
